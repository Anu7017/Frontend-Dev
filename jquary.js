// Assign different jQuery versions
var $v1 = jQuery.noConflict(true);  // jQuery 1
var $v2 = jQuery.noConflict(true);  // jQuery 3

// Carousel with Version 1
$v1(function () {
    let i = 0;
    function rotate() {
        let slides = $v1(".slide");
...
// Highlight widgets with Version 1
$v1(function () {
